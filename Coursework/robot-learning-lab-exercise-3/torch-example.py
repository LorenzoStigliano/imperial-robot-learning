...
class Network(torch.nn.Module):
    def __init__(self):
        ...
        self.layer_1 = torch.nn.Linear(in_features=4, out_features=10)
        self.layer_2 = torch.nn.Linear(in_features=10, out_features=10)
        self.output_layer = torch.nn.Linear(in_features=10, out_features=4)

    def forward(self, input_data):
        layer_1_output = torch.nn.functional.relu(self.layer_1(input_data))
